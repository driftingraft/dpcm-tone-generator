...
2. 「音程」で音名（C3など）を選ぶ。周波数を直接指定したい場合はHz欄に入力（音名より優先）
3. 「生成する」ボタンを押す
...
- **ダウンロード** — .dmcファイルとプレビューWAVを保存できます
...
- **プレビューWAVをZIP/保存先に含める** — チェックすると試聴用WAVもZIPに入ります
...
- **スケールプレビュー** — 全音階を低い方から順に鳴らしたWAV。音程の正確さを耳で確認できます
